    ...
    return (
        <section id="home" className="relative overflow-hidden bg-bgColor pb-10">
            <div className="max-w-7xl mx-auto px-6 md:py-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                >
                    <h1 className="text-3xl lg:text-4xl mt-5 font-semibold leading-tight text-primary">
                        One App for <br />
                        <span className="text-black">Multiple Services</span>
                    </h1>
...
//                     className="space-y-8"
//                 >
//                     <h1 className="text-2xl md:text-3xl lg:text-6xl mt-5 font-semibold leading-tight  text-primary">
//                         One App for <br />
