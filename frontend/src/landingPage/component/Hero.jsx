        ...
        <section id="home" className="relative overflow-hidden bg-[--color-secondary]">
            <div className="max-w-7xl mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <motion.div
                    ...
                    className="space-y-8"
                >
                    <h1 className="text-4xl md:text-5xl font-extrabold leading-tight text-[--color-dark]">
                        One App for <br />
                ...
                >
                    {/* Glow */}
                    <div className="absolute -top-10 -right-10 w-72 h-72 bg-[--color-primary]/30 rounded-full blur-3xl" />

                    <motion.img
                        src="/images/spa-mobile.png"
                        alt="Spa Service"
                        className="w-[200px] md:w-[230px] rounded-3xl shadow-2xl z-10"
                        animate={{ y: [0, -10, 0] }}
                    ...
                    <motion.img
                        ...
                        alt="Salon Service"
                        className="w-[200px] md:w-[230px] rounded-3xl shadow-2xl translate-x-[-40px] translate-y-[40px]"
                        animate={{ y: [0, 12, 0] }}
            ...
            >
                <motion.img
                    ...
                    alt="App UI"
                    className="w-[260px] md:w-[320px] rounded-3xl shadow-2xl"
                    animate={{ y: [0, -15, 0] }}
